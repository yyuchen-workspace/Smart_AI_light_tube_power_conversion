      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                _buildTableRow(
                  label: '每月電費',
                  oldValue: NumberFormatter.formatWithComma(oldMonthlyCost,
                      decimals: 0),
                  newValue: NumberFormatter.formatWithComma(newMonthlyCost,
                      decimals: 0),
                  unit: '元',
                ),
                ...
                _buildTableRow(
                  label: '每年電費',
                  oldValue: NumberFormatter.formatWithComma(oldMonthlyCost * 12,
                      decimals: 0),
                  newValue: NumberFormatter.formatWithComma(newMonthlyCost * 12,
                      decimals: 0),
                  unit: '元',
                ),
              ],
          ...
          _buildSavingDataRow(
            ...
            iconColor: Colors.blue[800]!,
            label: '共節省電費(月)',
            value: NumberFormatter.formatWithComma(
                oldMonthlyCost - newMonthlyCost,
                decimals: 0),
            unit: '元/月',
            isHighlight: true,
          ),
          ...
          _buildSavingDataRow(
            ...
            label: '共節省電費(年)',
            value: NumberFormatter.formatWithComma(
                (oldMonthlyCost - newMonthlyCost) * 12,
                decimals: 0),
            unit: '元/年',
            isHighlight: true,
          ),
