...
class LightingCalculator {
  // 車道燈固定感應次數
  static const int drivewayDaytimeSensing = 2325; // 日間感應次數
  static const int drivewayNighttimeSensing = 285; // 夜間感應次數
  static const int drivewayAllDaySensing = 2610; // 全天候 = 1440 + 885

  // 車位燈固定感應次數
  static const int parkingDaytimeSensing = 35; // 日間感應次數
  static const int parkingNighttimeSensing = 5; // 夜間感應次數
  static const int parkingAllDaySensing = 40; // 全天候 = 80 + 30
