                  ...
                  children: [
                    CheckboxListTile(
                      ...
                      shape: RoundedRectangleBorder(
                        ...
                        side: BorderSide(
                            color: isSummer ? Colors.blue : Colors.grey[300]!,
                            width: 2),
                      ),
                    ...
                    SizedBox(height: 12),
                    CheckboxListTile(
                      title: Text('非夏季 (1-5月、10-12月)',
                          style: TextStyle(fontSize: 16)),
                      subtitle: Text('每度 3.87 元',
                          style:
                              TextStyle(fontSize: 14, color: Colors.grey[600])),
                      value: !isSummer,
                      onChanged: (value) =>
                          onSeasonChanged(value == true ? false : true),
                      controlAffinity: ListTileControlAffinity.leading,
                      contentPadding: EdgeInsets.symmetric(horizontal: 8),
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(8),
                        side: BorderSide(
                            color:
                                !isSummer ? Colors.orange : Colors.grey[300]!,
                            width: 2),
                      ),
                      tileColor:
                          !isSummer ? Colors.orange[50] : Colors.grey[50],
                    ),
                  ],
                );
              } else {
                  ...
                  children: [
                    Expanded(
                      child: CheckboxListTile(
                        title:
                            Text('夏季 (6-9月)', style: TextStyle(fontSize: 16)),
                        subtitle: Text('每度 4.08 元',
                            style: TextStyle(
